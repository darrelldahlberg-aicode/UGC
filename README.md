...
UGC owns creator-specific operating rules, evidence handling, qualification, outreach, commercial terms, rights, approvals, performance review, and creator scorecards. Content Scaling, Creative Operating System, AI Video, Adley, and Otto retain their existing specialist responsibilities. This repository references those systems instead of duplicating them.
